...
4. Put EaglePatch+AC1.asi and EaglePatch+AC1.ini into a newly created scripts folder
5. Done! You may want to check EaglePatch+AC1.ini for any settings you want to enable or disable
